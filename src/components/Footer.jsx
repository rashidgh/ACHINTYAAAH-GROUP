      ...
      <div className="relative max-w-7xl mx-auto grid gap-12 md:grid-cols-4">
        ...
        >
          <h3 className={`text-2xl font-bold mb-4 ${isNight ? "text-white" : "text-gray-900"}`}>
            ACHINTYAAAH<span className={isNight ? "text-indigo-400" : "text-indigo-500"}>.</span>
          </h3>
          <p className={`${isNight ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
            Crafting scalable digital solutions with precision, creativity, and performance at the core.
          </p>
        </motion.div>
        ...
        >
          <h4 className={`font-semibold mb-4 ${isNight ? "text-white" : "text-gray-900"}`}>Quick Links</h4>
        ...
        >
          <h4 className={`font-semibold mb-4 ${isNight ? "text-white" : "text-gray-900"}`}>What We Do</h4>
